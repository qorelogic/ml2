    ...
    def monitorAccountsMarginCloseout(self):
        ...
        with p.option_context('display.max_rows', 4000, 'display.max_columns', 4000, 'display.width', 1000000):
            ...
            mfdf['initialCapital2'] = p.Series({
                ...
                '101-004-1984564-002':1000,
                '101-004-1984564-003':1000, #???
                '101-004-1984564-004':100000, #???
                '101-004-1984564-005':10000000,
                '101-004-1984564-006':100000000,
                '101-004-1984564-007':1000000000,
                '101-004-1984564-008':100000,
                '101-004-1984564-009':262,
                '101-004-1984564-010':9000, #?
                '101-004-1984564-011':120000,
                '101-004-1984564-012':45000,
                '101-004-1984564-013':90000,
            })
