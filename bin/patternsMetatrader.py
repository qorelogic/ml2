...
def main():
    ...
    with p.option_context('display.max_rows', 4000, 'display.max_columns', 4000, 'display.width', 1000000):
        fields = 'side lots lotsEtoro _lotsEtoroRT _lotsEtoroRT2 _boolLotsEtoroRT2 _diffpLotsEtoro minimumLeverageEtoro unitsEtoro balanceMetatrader leverageMetatrader allMarginMetatrader amount2Metatrader closeTradePLMetatrader side diffp lots'.split(' ')
