...
alias .gl="git log --graph --numstat --parents"
alias .glp="git log --graph --parents -p"
alias .glo="git log --oneline --graph --parents"
alias .glon="git log --oneline --parents --numstat"
