...
alias .gl="  git log --all --decorate --graph $gformat --numstat --parents"
alias .glp=" git log --all --decorate --graph $gformat --parents -p"
alias .glo=" git log --all --decorate --graph --oneline --parents $gformat"
alias .glor=" git log --all --decorate --oneline --parents $gformat --reverse"
alias .glo2=" git log --all --decorate --graph --oneline --parents $gformat2"
alias .glor2=" git log --all --decorate --oneline --parents $gformat2 --reverse"
alias .glon="git log --all --decorate --oneline $gformat --parents --numstat"
alias .gla=" git log --all --decorate --graph $gformat | sg2p | less"
alias gl=".gl"
alias glp=".glp"
alias glo=".glo"
alias glor=".glor"
